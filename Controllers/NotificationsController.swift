    ...
    func enableNotifications() {
        ...
        notificationsAllowed()
            ...
            .startWithValues { _ in
                let alert = UIAlertController(title: NSLocalizedString("Notifications Disabled", comment: ""), message: NSLocalizedString("You have disabled notifications for PHMemory. If you want to receive notifications you need to enable this access in Settings. Would you like to do this now?", comment: ""), preferredStyle: .alert)
